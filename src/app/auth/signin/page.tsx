    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-gray-900/50 border-red-900/30 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-white spooky-font">
            Welcome to <span className="text-red-500">HauntedTrails</span>
          </CardTitle>
          <p className="text-gray-400 text-sm mt-2">
            Sign in to explore Indonesia&apos;s most haunted locations
          </p>
        </CardHeader>
